...
class MetricFlowConfig(BaseModel):
    ...
    mf_path: str = Field(
        default="/Users/zhaoheng/miniconda3/envs/metricflow/bin/mf", description="Path to the mf CLI executable"
    )
    ...
    def from_env(cls) -> "MetricFlowConfig":
        ...
        return cls(
            mf_path=os.getenv("MF_PATH", "/Users/zhaoheng/miniconda3/envs/metricflow/bin/mf"),
